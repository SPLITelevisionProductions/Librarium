...
if(isset($_POST['submit'])){
    ...
    $uid = uniqid($un,true);
		...
		try {
			...
			$stmt = $db->prepare('INSERT INTO users (username,UID,password,email,fname,lname,location,active) VALUES (:username, :uid, :password, :email, :fname, :lname, :location, :active)');
			$stmt->execute(array(
        ...
        ':uid' => $uid,
			...
			<p>To activate your account, please click on this link: <a href='".DIR."admin/activate.php?x=$id&y=$activation'>".DIR."admin/activate.php?x=$id&y=$activation</a></p>
